...
import screenshotVatReturns from "@/public/images/screenshots/pic1.webp";
const features = [
  {
    title: "風水",
  ...
  {
    title: "對象",
    description: "可以用表單功能選擇對象，並且可以查看對象的詳細資料。",
    image: screenshotExpenses,
  },
  {
    title: "商務",
    description: "不少工具對未來的日子有幫助",
    image: screenshotVatReturns,
  },
  {
    title: "星座",
    description: "星座是一種中國古老的學問，主要是研究人的命運。",
      ...
      <Container className="relative">
        <div className="max-w-2xl md:mx-auto md:text-center xl:max-w-none">
          ...
          <p className="mt-6 text-lg tracking-tight text-blue-100">
            這是一個簡短的描述，解釋這個產品有多棒。這是一個簡短的描述，解釋這個產品有多棒。
          </p>
        </div>
        <Tab.Group
          as="div"
