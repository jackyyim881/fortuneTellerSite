import { byLunar, bySolar } from "iztro/lib/astro";
import { astro } from "iztro";
import { submitData } from "../action";
import { getFengshui } from "./action";
import AstrolabeDisplay from "./display";

export default async function Page() {
  return (
    <div className="p-6 max-w-lg mx-auto bg-white rounded-xl shadow-md space-y-4">
      <h1 className="text-3xl font-bold text-center text-gray-900">风水</h1>
